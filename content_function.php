<?php
	...
	function disptopics($cid, $scid) {
		...
		if (mysqli_num_rows($select) != 0) {
			...
			echo "<tr><th>Titulo</th><th>Postado por</th><th>Data da Postagem</th><th>Visualizações</th><th>Respostas</th></tr>";
			while ($row = mysqli_fetch_assoc($select)) {
			...
			echo "<p>Esta categoria ainda não tem tópico criado. <a href='/forum-tutorial/newtopic/".$cid."/".$scid."'>
				 Seja o primeiro a postar um tópico aqui!</a></p>";
		}
	}
	...
	function replylink($cid, $scid, $tid) {
		echo "<p><a href='/forum-tutorial/replyto/".$cid."/".$scid."/".$tid."'>Responda este topico</a></p>";
	}
